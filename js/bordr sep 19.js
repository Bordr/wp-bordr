				...
				$(data.crossings).each(function(i, el){
					var fdata;
						...
						fdata = "<article class='box'>" +
								"	<h2>"+data.crossings[i].border+"</h2>";
						if (data.crossings[i].dep!=null && data.crossings[i].dep!=undefined) {
							fdata = fdata + "<p><a href='/activities/"+data.crossings[i].dep+"/?from_story="+data.crossings[i].id+"'>context: the  "+data.crossings[i].depn+" activity</a></p>";
						}
